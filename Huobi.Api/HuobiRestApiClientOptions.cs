...
public class HuobiRestApiClientOptions : RestApiClientOptions
{
    // Receive Window
    ...
    public HuobiRestApiClientOptions(ApiCredentials credentials)
    {
        // API Credentials
        ...
        RateLimiters = new List<IRateLimiter>
        {
            new RateLimiter()
                /*
                // General
                .AddApiKeyLimit(900, TimeSpan.FromSeconds(1), false)
