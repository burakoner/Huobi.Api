...
public class HuobiSubmittedOrderUpdate : HuobiOrderUpdate
{
    ...
    /// </summary>
    [JsonIgnore]
    public SpotOrderType Type => new OrderTypeConverter(false).ReadString(TypeInternal);

    /// <summary>
    /// The type of the order
    /// </summary>
    [JsonIgnore]
    public SpotOrderSide Side => new SpotOrderSideConverter(false).ReadString(TypeInternal);
    /// <summary>
    /// Creation time
    /// </summary>
...
public class HuobiTriggerFailureOrderUpdate : HuobiOrderUpdate
{
    ...
    /// Side of the order
    /// </summary>
    [JsonProperty("orderSide"), JsonConverter(typeof(SpotOrderSideConverter))]
